...
CREATE TABLE IF NOT EXISTS eb_store_product (
  ...
  is_police INT,
  brand_id INT,
  brand_com VARCHAR(255),
  unit_name VARCHAR(255),
  code VARCHAR(255),
  video_open INT,
  video_link VARCHAR(255),
  is_vip_product INT,
  is_channel_product INT,
  is_general_product INT,
  is_presale_product INT,
  presale_start_time INT,
  presale_end_time INT,
  presale_day INT,
  auto_on_time INT,
  auto_off_time INT,
  give_integral DECIMAL(10,2),
  is_vip INT,
  store_label_id VARCHAR(255),
  ensure_id VARCHAR(255),
  specs TEXT,
  specs_id INT,
  is_limit INT,
  limit_type INT,
  limit_num INT,
  is_support_refund INT,
  custom_form TEXT,
  is_brokerage INT,
  brokerage_type INT,
  level_type INT,
...
CREATE TABLE IF NOT EXISTS eb_store_product_attr_value (
  ...
  settle_price DECIMAL(12,2) DEFAULT 0.00,
  image VARCHAR(255),
  `unique` VARCHAR(32),
  cost DECIMAL(12,2) DEFAULT 0.00,
  bar_code VARCHAR(50),
  ot_price DECIMAL(12,2) DEFAULT 0.00,
  vip_price DECIMAL(12,2) DEFAULT 0.00,
  weight DECIMAL(12,2) DEFAULT 0.00,
  volume DECIMAL(12,2) DEFAULT 0.00,
  brokerage DECIMAL(12,2) DEFAULT 0.00,
  brokerage_two DECIMAL(12,2) DEFAULT 0.00,
  level_price VARCHAR(512),
  is_default_select INT DEFAULT 0,
